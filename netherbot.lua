...
lookupFrame:ClearAllPoints()
lookupFrame:Hide()

lookupFrame:SetScript("OnShow", function(self)
  -- si la frame Admin est visible, on colle la lookupFrame à sa droite
  if adminFrame and adminFrame:IsShown() then
    self:SetPoint("TOPLEFT", adminFrame, "TOPRIGHT", 10, 0)

  -- sinon on la colle à la droite de la main GUI Ace3 (self.gui.frame)
